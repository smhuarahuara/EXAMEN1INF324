...
<body>
    ...
    <div id="menu">
        ...
        <?php
            ...
            <tr>
                <?php
                    echo "<td><a href='./index.php/Welcome/indexi?v=1'>Informatica</a></td>";
                ?>        
            </tr>
            <tr>
                <?php
                    echo "<td><a href='./index.php/Welcome/indexf?v=1'>Fisica</a></td>";
                ?>  
            </tr>
            <tr>
            <?php
                    echo "<td><a href='./index.php/Welcome/indexi?v=1'>Quimica</a></td>";
                ?>  
            </tr>
